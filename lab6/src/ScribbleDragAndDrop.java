...
{
    ArrayList<Scribble> scribbles = new ArrayList<Scribble>();
     ...
     */
    public ScribbleDragAndDrop(int param, int x, int y) {
        // Give ourselves a nice default border.
        // We'll change this border during drag-and-drop.
        setBorder(normalBorder);

        scribbles.add(new MyStroke(10).createStrokedShape(new Figure(x, y, 90)));
